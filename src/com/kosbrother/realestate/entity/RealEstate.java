...
public class RealEstate
{
	...
	public RealEstate(int id, int estate_group, String estate_town,
			String estate_type, String estate_address,
			double ground_exchange_area, double ground_rent_area,
			String ground_usage, String date_buy, String content_buy,
			String date_rent, String content_rent, String rent_layer,
			String buy_layer, int building_total_layer, String building_type,
			String main_purpose, String main_material, String date_built,
			double building_exchange_area, int building_room,
			int building_sitting_room, int building_rest_room,
			String is_guarding, String is_having_furniture,
			int buy_total_price, double buy_per_square_feet,
			int rent_total_price, double rent_per_square_feet,
			String parking_type, double parking_exchange_area,
