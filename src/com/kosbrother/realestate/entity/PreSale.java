...
public class PreSale
{
	...
	public PreSale(String estate_town, String estate_type,
			String estate_address, double ground_exchange_area,
			...
			String is_guarding, int buy_total_price,
			double buy_per_square_feet, String parking_type,
