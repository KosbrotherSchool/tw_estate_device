...
public class Datas {
	...
	public static class BuyPerSquareComparator implements Comparator<RealEstate>{
	    ...
	    public int compare(RealEstate es1, RealEstate es2) {
	    	if(myOrder==0){
	    		return Double.compare(es1.buy_per_square_feet, es2.buy_per_square_feet);
	    	}else{
	    		return -Double.compare(es1.buy_per_square_feet, es2.buy_per_square_feet);
	    	}
	    }
	...
	public static class BuyTotalPriceComparator implements Comparator<RealEstate>{
	...
	public static class BuildingExchangeAreaComparator implements Comparator<RealEstate>{
	    ...
	    public int compare(RealEstate es1, RealEstate es2) {
	    	if(myOrder==0){
	    		return Double.compare(es1.building_exchange_area, es2.building_exchange_area);
	    	}else{
	    		return -Double.compare(es1.building_exchange_area, es2.building_exchange_area);
	    	}
	    }
	...
	public static class BuiltDateComparator implements Comparator<RealEstate>{
	    ...
	    @Override
	    public int compare(RealEstate es1, RealEstate es2) {
	    	return -Double.compare(Integer.valueOf(es1.date_buy), Integer.valueOf(es2.date_buy));
