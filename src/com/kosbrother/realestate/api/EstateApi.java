...
public class EstateApi {
    ...
    public static ArrayList<RealEstate> getAroundAll(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/around_all?"+"x="+ x +"&y="+ y, null, null);
    ...
    public static ArrayList<RealEstate> getAroundEstate(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/estate_around?"+"x="+ x +"&y="+ y, null, null);
    	ArrayList<RealEstate> realEstates = new ArrayList<RealEstate>();
    	if (message == null) {
            return null;
        } else {
    ...
    public static ArrayList<RealEstate> getAroundPreSale(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/presale_around?"+"x="+ x +"&y="+ y, null, null);
    	ArrayList<RealEstate> realEstates = new ArrayList<RealEstate>();
    	if (message == null) {
            return null;
        } else {
    ...
    public static ArrayList<RealEstate> getAroundRent(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/rent_around?"+"x="+ x +"&y="+ y, null, null);
    	ArrayList<RealEstate> realEstates = new ArrayList<RealEstate>();
    	if (message == null) {
            return null;
        } else {
    ...
    public static ArrayList<RealEstate> getAroundEstateAndPresale(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/estate_and_pre_sale_around?"+"x="+ x +"&y="+ y, null, null);
    	ArrayList<RealEstate> realEstates = new ArrayList<RealEstate>();
    	if (message == null) {
            return null;
        } else {
    ...
    public static ArrayList<RealEstate> getAroundEstateAndRent(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/estate_and_rent_around?"+"x="+ x +"&y="+ y, null, null);
    	ArrayList<RealEstate> realEstates = new ArrayList<RealEstate>();
    	if (message == null) {
            return null;
        } else {
    ...
    public static ArrayList<RealEstate> getAroundPresaleAndRent(double x, double y){
    	String message = getMessageFromServer("GET", "/api/v1/real_estate/pre_sale_and_rent_around?"+"x="+ x +"&y="+ y, null, null);
    	ArrayList<RealEstate> realEstates = new ArrayList<RealEstate>();
    	if (message == null) {
            return null;
        } else {
	...
	private static ArrayList<RealEstate> parseEstateMessage(String message, ArrayList<RealEstate> realEstates) {
		try {
            JSONArray jArray;
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                try{
                	ground_exchange_area = jArray.getJSONObject(i).getDouble("ground_exchange_area");
                }catch(Exception e){
                ...
                int building_total_layer = jArray.getJSONObject(i).getInt("building_total_layer");
                ...
                double building_exchange_area = jArray.getJSONObject(i).getDouble("building_exchange_area");      
                ...
                try{
                	rent_per_square_feet = jArray.getJSONObject(i).getDouble("rent_per_square_feet");
                }catch(Exception e){
                ...
                try{
                	parking_exchange_area = jArray.getJSONObject(i).getDouble("parking_exchange_area");
                }catch(Exception e){
...
//              RealEstate(int id, int estate_group, String estate_town, String estate_type, String estate_address,
...
//    			double x_lat, double y_long)
                ...
                RealEstate newEstate = new RealEstate(id, estate_group, estate_town, estate_type,estate_address,
                		...
                		building_exchange_area, building_room, building_sitting_room, building_rest_room, 
                		is_guarding, is_having_furniture,
                		buy_total_price, buy_per_square_feet, rent_total_price, rent_per_square_feet,
                		parking_type, parking_exchange_area, parking_total_price,
                		x_lat, y_long);
