...
public class FavoriteActivity extends SherlockFragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mAdapter = new ListEstateAdapter(FavoriteActivity.this, Datas.mEstates);
	...
	private void setDrawerLayout()
	{
		...
		mDrawerAdapter = new EntryAdapter(FavoriteActivity.this, items);
			...
			com.actionbarsherlock.view.MenuItem item)
	{
		...
		} else
		{
			...
			{
			case ID_SEARCH:
				Toast.makeText(FavoriteActivity.this, "search", Toast.LENGTH_SHORT)
						.show();
				break;
			case R.id.menu_map:
				Toast.makeText(FavoriteActivity.this, "Map", Toast.LENGTH_SHORT)
						.show();
				break;
